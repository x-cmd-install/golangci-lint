...
[![x-cmd/install — golangci-lint Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/golangci-lint.svg?lang=zh)](https://x-cmd.com/install/golangci-lint)
...
合计: **211,666** 行代码（覆盖前 5 种语言、共 **1683** 个文件）。
...
- **Star**: 19,395 · **Fork**: 1,626 · **开放 issue**: 1,983 · **贡献者**: 368

## 累计统计

- **发布数**: 192 · **已合并 PR**: 3664 · **开放 PR**: 23 · **已关闭 issue**: 1886 · **开放 issue**: 97 · **提交数**: 4236
...
_数据快照: `data/card/260924.yml` · 2026-09-24T05:44:46Z._
